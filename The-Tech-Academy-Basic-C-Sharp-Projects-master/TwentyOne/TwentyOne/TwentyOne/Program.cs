    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!validAnswer)
            {
                ...
                if (!validAnswer) Console.WriteLine("Please enter numeric digits only with no decimals!");
            }
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\Eric Freeman\Logs\log.txt", true))
                {
        ...
        private static void UpdateDbWithException(Exception ex)
        {
            string connectionString = @"Data Source = (localdb)\MSSQLLocalDB; Initial 
                Catalog = TwentyOneGame; Integrated Security = True; Connect Timeout = 30; 
